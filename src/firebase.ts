...
import { getAuth, GoogleAuthProvider, signInWithPopup, getRedirectResult, onAuthStateChanged, signOut } from "firebase/auth";
...
export { app, auth, provider, signInWithPopup, getRedirectResult, onAuthStateChanged, signOut };
